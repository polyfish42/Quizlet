...
var _user$project$QuizletCss$appearance = function (value) {
	return _rtfeldman$elm_css$Css$mixin(
		{
			ctor: '::',
			_0: A2(_rtfeldman$elm_css$Css$property, '-moz-appearance', value),
			_1: {
				ctor: '::',
				_0: A2(_rtfeldman$elm_css$Css$property, '-webkit-appearance', value),
				_1: {
					ctor: '::',
					_0: A2(_rtfeldman$elm_css$Css$property, 'appearance', value),
					_1: {ctor: '[]'}
				}
			}
		});
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css_Elements$h6,
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css_Elements$blockquote,
														_1: {
															ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Css$backgroundImage(
								_rtfeldman$elm_css$Css$url('https://www.goodhire.com/hubfs/Q2_DG_ComplianceQuiz_Background.jpeg')),
							_1: {
								ctor: '::',
...
var _user$project$Quizlet$viewDropdown = function () {
	var options = {
		ctor: '::',
		_0: '1 - 10 per year',
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: '500 - 1500 per year',
						_1: {
							ctor: '::',
							_0: '1500 - 2500 per year',
							_1: {
								ctor: '::',
								_0: 'Over 2500 per year',
								_1: {ctor: '[]'}
							}
						}
					}
	...
	var viewOption = function (optionText) {
		return A2(
			_elm_lang$html$Html$option,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(optionText),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(optionText),
				_1: {ctor: '[]'}
			});
	};
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('- How Many Background Checks Will You Run This Year? -'),
				_1: {ctor: '[]'}
			}),
		_1: A2(_elm_lang$core$List$map, viewOption, options)
	};
}();
var _user$project$Quizlet$isTrue = function (bool) {
	return _elm_lang$core$Native_Utils.eq(bool, true);
};
var _user$project$Quizlet$blacklistedEmails = {
	ctor: '::',
	_0: 'outlook.com',
	_1: {
		ctor: '::',
...
var _user$project$Quizlet$onBlacklist = function (email) {
	return A2(
		_elm_lang$core$List$any,
		_user$project$Quizlet$isTrue,
		A2(
			_elm_lang$core$List$map,
			function (x) {
...
var _user$project$Quizlet$class = _user$project$Quizlet$_p0.$class;
var _user$project$Quizlet$classList = _user$project$Quizlet$_p0.classList;
var _user$project$Quizlet$viewError = function (error) {
	var _p1 = error;
	if (_p1.ctor === 'Just') {
		return {
			ctor: '::',
...
var _user$project$Quizlet$viewEnd = A2(
	_elm_lang$html$Html$div,
	{
		...
		_0: _user$project$Quizlet$class(
			{
				ctor: '::',
				_0: _user$project$QuizletCss$Slide,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Thank you! Please check your email to see your answers.'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Quizlet$hsContextParam = function (model) {
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'hutk',
						_1: _elm_lang$core$Json_Encode$string(model.cookie)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'ipaddress',
							_1: _elm_lang$core$Json_Encode$string(model.ipAddress)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'pageUrl',
								_1: _elm_lang$core$Json_Encode$string('https://www.goodhire.com/compliance-quiz')
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'pageName',
									_1: _elm_lang$core$Json_Encode$string('2017_Q1_DG_ComplianceCampaign_ComplianceQuizLP')
								},
								_1: {
									ctor: '::',
									_0: {
...
var _user$project$Quizlet$url = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
					...
					A2(
						...
						A2(
							...
							_elm_lang$core$List$head(
								A2(_elm_lang$core$String$split, ' ', model.name))),
						A2(
							_elm_lang$core$Basics_ops['++'],
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											'&hs_context=',
											_user$project$Quizlet$hsContextParam(model)))))))))));
};
var _user$project$Quizlet$hubspotRequest = function (model) {
	return _elm_lang$http$Http$request(
		{
			method: 'POST',
			headers: {ctor: '[]'},
			url: _user$project$Quizlet$url(model),
			body: _elm_lang$http$Http$emptyBody,
...
var _user$project$Quizlet$stylesheet = function () {
	...
	var attrs = {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'stylesheet.css'),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$Quizlet$getCookie = _elm_lang$core$Native_Platform.outgoingPort(
	'getCookie',
	function (v) {
		return v;
	});
var _user$project$Quizlet$hubspotCookie = _elm_lang$core$Native_Platform.incomingPort('hubspotCookie', _elm_lang$core$Json_Decode$string);
var _user$project$Quizlet$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {screens: a, score: b, name: c, workEmail: d, expectedChecksPerYear: e, error: f, cookie: g, quizSize: h, ipAddress: i, location: j};
									};
								};
							};
						};
...
var _user$project$Quizlet$End = {ctor: 'End'};
var _user$project$Quizlet$currentScreen = function (screenList) {
	var _p3 = _elm_lang$core$List$head(screenList);
	if (_p3.ctor === 'Just') {
		return _p3._0;
	} else {
		return _user$project$Quizlet$End;
	}
};
var _user$project$Quizlet$Results = {ctor: 'Results'};
var _user$project$Quizlet$Question = function (a) {
	return {ctor: 'Question', _0: a};
};
var _user$project$Quizlet$Intro = {ctor: 'Intro'};
var _user$project$Quizlet$Wrong = function (a) {
	return {ctor: 'Wrong', _0: a};
};
var _user$project$Quizlet$Correct = function (a) {
	return {ctor: 'Correct', _0: a};
};
var _user$project$Quizlet$questions = {
	ctor: '::',
	_0: _user$project$Quizlet$Question(
		{
			ctor: '_Tuple2',
			_0: 'It\'s illegal to look at a candidate\'s social media accounts during the hiring process',
			_1: {
				ctor: '::',
				_0: _user$project$Quizlet$Wrong('True'),
				_1: {
					ctor: '::',
					_0: _user$project$Quizlet$Correct('False'),
					_1: {ctor: '[]'}
				}
			}
		}),
	_1: {
		...
		_0: _user$project$Quizlet$Question(
			{
				ctor: '_Tuple2',
				_0: 'The ban-the-box movement\'s main goal is to remove what from the hiring process?',
				_1: {
					ctor: '::',
					_0: _user$project$Quizlet$Wrong('Interview questions about convictions'),
					_1: {
						ctor: '::',
						_0: _user$project$Quizlet$Correct('Criminal-record checkbox on applications'),
						_1: {
							ctor: '::',
							_0: _user$project$Quizlet$Wrong('Background checks'),
							_1: {
								ctor: '::',
								_0: _user$project$Quizlet$Wrong('All of the above'),
								_1: {ctor: '[]'}
							}
						}
					}
		...
		_1: {
			...
			_0: _user$project$Quizlet$Question(
				{
					...
					_0: A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], 'because of a background check. Who faces legal repercussions if the notices ', 'aren\'t delivered to the candidate?')),
					_1: {
						ctor: '::',
						_0: _user$project$Quizlet$Wrong('The job candidate'),
						_1: {
							ctor: '::',
							_0: _user$project$Quizlet$Wrong('The data provider'),
							_1: {
								ctor: '::',
								_0: _user$project$Quizlet$Wrong('The CRA'),
								_1: {
									ctor: '::',
									_0: _user$project$Quizlet$Correct('The employer'),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			_1: {
				...
				_0: _user$project$Quizlet$Question(
					{
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Basics_ops['++'], 'According to the FCRA, a background check company may report criminal convictions ', 'for people applying for positions that pay $75,000/year or more for how long?'),
						_1: {
							ctor: '::',
							_0: _user$project$Quizlet$Wrong('5 years'),
							_1: {
								ctor: '::',
								_0: _user$project$Quizlet$Wrong('7 years'),
								_1: {
									ctor: '::',
									_0: _user$project$Quizlet$Wrong('12 years'),
									_1: {
										ctor: '::',
										_0: _user$project$Quizlet$Correct('Unlimited'),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_1: {
					...
					_0: _user$project$Quizlet$Question(
						{
							ctor: '_Tuple2',
							_0: A2(_elm_lang$core$Basics_ops['++'], 'The FCRA does not apply if you have job candidates pay to run a background check on ', 'themselves and show you the results.'),
							_1: {
								ctor: '::',
								_0: _user$project$Quizlet$Wrong('True'),
								_1: {
...
var _user$project$Quizlet$totalScore = function (score) {
	return score + ((100 / _elm_lang$core$List$length(_user$project$Quizlet$questions)) | 0);
};
var _user$project$Quizlet$HubspotResponse = function (a) {
	return {ctor: 'HubspotResponse', _0: a};
};
var _user$project$Quizlet$submitForm = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Quizlet$HubspotResponse,
		_user$project$Quizlet$hubspotRequest(model));
};
var _user$project$Quizlet$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'Resize':
			...
			case 'ExpectedChecksPerYear':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{expectedChecksPerYear: _p4._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'EmailError':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							error: _elm_lang$core$Maybe$Just('Please enter your work email.')
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Submit':
...
var _user$project$Quizlet$EmailError = {ctor: 'EmailError'};
var _user$project$Quizlet$validateForm = function (email) {
	return _elm_lang$core$Native_Utils.eq(email, '') ? _user$project$Quizlet$EmailError : (_user$project$Quizlet$onBlacklist(email) ? _user$project$Quizlet$EmailError : _user$project$Quizlet$Submit);
};
var _user$project$Quizlet$ExpectedChecksPerYear = function (a) {
	return {ctor: 'ExpectedChecksPerYear', _0: a};
};
var _user$project$Quizlet$WorkEmail = function (a) {
	return {ctor: 'WorkEmail', _0: a};
};
var _user$project$Quizlet$Name = function (a) {
	return {ctor: 'Name', _0: a};
};
var _user$project$Quizlet$viewForm = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Quizlet$viewError(model.error),
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Work Email'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Quizlet$WorkEmail),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					...
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Quizlet$Name),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Quizlet$ExpectedChecksPerYear),
									_1: {ctor: '[]'}
								},
								_user$project$Quizlet$viewDropdown),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Quizlet$id(_user$project$QuizletCss$SubmitButton),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Quizlet$viewResults = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								...
								'% correct. Enter your work email to get the detailed answer guide.'))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Quizlet$viewForm(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Quizlet$AnsweredCorrect = {ctor: 'AnsweredCorrect'};
var _user$project$Quizlet$NextScreen = {ctor: 'NextScreen'};
var _user$project$Quizlet$viewIntro = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Quizlet$class(
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Quizlet$id(_user$project$QuizletCss$StartButton),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$Quizlet$viewChoice = F2(
...
var _user$project$Quizlet$viewQuestion = F2(
	function (question, choices) {
		return A2(
			...
			A2(
				...
				A2(_elm_lang$core$List$indexedMap, _user$project$Quizlet$viewChoice, choices)));
	});
var _user$project$Quizlet$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Quizlet$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Quizlet$IpAddressResponse = function (a) {
	return {ctor: 'IpAddressResponse', _0: a};
};
var _user$project$Quizlet$getIpAddress = A2(
	_elm_lang$http$Http$send,
	_user$project$Quizlet$IpAddressResponse,
	A2(
		_elm_lang$http$Http$get,
		'http://freegeoip.net/json/',
		A2(_elm_lang$core$Json_Decode$field, 'ip', _elm_lang$core$Json_Decode$string)));
var _user$project$Quizlet$Cookie = function (a) {
	return {ctor: 'Cookie', _0: a};
};
var _user$project$Quizlet$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _user$project$Quizlet$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: {
			screens: {
				ctor: '::',
				_0: _user$project$Quizlet$Intro,
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Quizlet$questions,
					{
						ctor: '::',
						_0: _user$project$Quizlet$Results,
						_1: {
							ctor: '::',
							_0: _user$project$Quizlet$End,
							_1: {ctor: '[]'}
						}
					})
			},
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _user$project$Quizlet$getCookie('hubspotutk'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Task$perform, _user$project$Quizlet$Resize, _elm_lang$window$Window$width),
					_1: {
						ctor: '::',
						_0: _user$project$Quizlet$getIpAddress,
						_1: {ctor: '[]'}
					}
				}
			})
...
var _user$project$Quizlet$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Quizlet$hubspotCookie(_user$project$Quizlet$Cookie),
			_1: {
				ctor: '::',
				_0: _elm_lang$window$Window$resizes(
					function (x) {
						return _user$project$Quizlet$Resize(x.width);
					}),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Quizlet$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Quizlet$UrlChange,
	{init: _user$project$Quizlet$init, update: _user$project$Quizlet$update, subscriptions: _user$project$Quizlet$subscriptions, view: _user$project$Quizlet$view})();

var Elm = {};
Elm['Quizlet'] = Elm['Quizlet'] || {};
if (typeof _user$project$Quizlet$main !== 'undefined') {
    _user$project$Quizlet$main(Elm['Quizlet'], 'Quizlet', undefined);
}
